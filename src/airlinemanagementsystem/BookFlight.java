...
public class BookFlight extends JFrame implements ActionListener{
    ...
    JTextField  tfaadhar;
    JLabel tfname, tfnationality, tfaddress, labelgender, labelfcode, labelfname;
...
//            String address = tfaddress.getText();
            ...
            try{
                ...
                String query = "insert into reservation values('PNR-"+random.nextInt(100000)+"', 'TIC-"+random.nextInt(1000)+"', '"+aadhar+"', '"+name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+src+"', '"+dest+"', '"+ddate+"')";
